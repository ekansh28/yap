"""
Django settings for yapchat project.
...
SECRET_KEY = 'django-insecure-amr(@3eb7()j@yrkg(=io$!5a9oo=@ryz&%nup4^x$jm&qrh@i'
...
ASGI_APPLICATION = "yapchat.asgi.application"

WSGI_APPLICATION = 'yapchat.wsgi.application'
...
R2_BUCKET_NAME = os.getenv("R2_BUCKET_NAME", "yapchat")
R2_CUSTOM_DOMAIN = os.getenv("R2_CUSTOM_DOMAIN", "https://cdn.lesbianhangout.online")
